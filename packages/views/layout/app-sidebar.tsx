...
import { deduplicateInboxItems, getInboxItemsFromPages, inboxListOptions } from "@multica/core/inbox/queries";
...
export function AppSidebar({ topSlot, searchSlot, headerClassName, headerStyle }: AppSidebarProps = {}) {
  ...
  const inboxItems = React.useMemo(() => getInboxItemsFromPages(inboxPages), [inboxPages]);
